...
>
> **Active work:** Product lane complete — #127 ✅ #126 ✅ #129 ✅ **#99 ✅ (owner decision: redo internal-only; orphan recovery + embed backup verified)**. All four product PRDs accepted and closed; #130 product-lane checklist fully checked. Release publication remains owner-controlled. **Next:** RC owner acceptance → post-RC #133 (deterministic collectors) → #134 (HTML + CI gate).
>
> ---
>
