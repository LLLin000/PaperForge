...
>
> **Active work:** #127 ✅, #126 ✅, **#129 (display restore semantics) implemented + review PASS** — display-only restore with confirmation, provenance persistence (formal + backup paths), restore-aware drift override, stale notice with raw timestamp comparison. Full suite green (456 plugin + focused python). Release publication remains owner-controlled. **Next:** #99 owner decision (redo-safety path reconfirmation) → RC acceptance → #133/#134.
>
> ---
>
