...
>
> **Active work:** #127 accepted and closed; **#126 (OCR Workspace closure) implemented across 4 PRs + review fixes — two-axis review PASS** (3 findings fixed: dropped keys surfaced, real workspace stop, per-filter selection reset; reload enrichment preserved). Full suite 2867 passed / 292 skipped / 25 sandbox-lock + 2 known production-vault search timeouts (environmental). Release publication remains owner-controlled. **Next:** ledger commit → #126 acceptance → #129 (display restore semantics).
>
> ---
>
