...
1. 🎯 **[#127 System-wide API cost and next_actions policy](https://github.com/LLLin000/PaperForge/issues/127)** — **sole `ready-for-agent`** after the triage checkpoint. Defines the `PFResult.next_actions` contract that #126/#129 consume.
