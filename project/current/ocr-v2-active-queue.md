...
> **Current priority (2026-09-11): Plugin major-release acceptance — ACTIVE.** Tracker live: PRD **#192**, work packages **#193–#216** (`## Blocked by` edges), source-risk bugs **#217** (setup-journey config bypass) and **#218** (dead version-mode buttons). **W00 (#193) is ready-for-human**: owner decisions remain pending for version, Release-N, support/rollback window, OS/arch matrix, quality/performance thresholds, live-provider spend cap, and #218 button semantics. **W01 (#194) and W02 (#195) engineering evidence is complete** in the issue records (W01 real-host 13/13 final failure-branch coverage; W02 real Node→Python protocol coverage); both GitHub issues remain OPEN and #196 is stale `blocked by #195`. Do not rerun W01/W02 for bookkeeping; after W00, the next implementation is W03/#217 canonical config/auth. Final candidate certification remains pending.
...
> **Last updated:** 2026-09-11. Architecture deterministic substrate and Review v2 implementation, including plan-to-emit scope binding, are closed and hosted-CI verified; no release/tag/package publication is authorized until the owner-controlled release gates pass.
