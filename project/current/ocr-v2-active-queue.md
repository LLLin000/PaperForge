...
> **Planning baseline:** `d1244f96ef6e0f8c61c1bdf3510e0c771f1c479e`. W01/W02 package evidence is closed and W03/#217 H-layer evidence is verified on committed harness `a2272995` (real UI → canonical config readback → same-sandbox restart → controlled provider request). Ticket 07 remains CLOSED / SEALED; Reconcile Core remains frozen. Production/provider work and publication require their respective explicit owner gates.
