...
def resolve_final_role(
    ...
    if current_role == "body_paragraph" and style_family:
        _NON_BODY_FAMILIES = {"reference_like", "table_caption_like", "legend_like", "heading_like", "support_like"}
        _STRONG_AUTHORITIES = {
            "figure_marker",
            "figure_family_anchor",
            "reference_marker",
