...
const LANG: Record<string, Record<string, string>> = {
  en: {
    ...
    cc_heading: "Control center",
    nav_home: "Control center",
    ...
    setup_nav_exit: "Back to control center",
    setup_install_cancelled: "Setup cancelled. The runtime was not activated.",
    ...
    ocr_ws_pagination_previous: "Previous page",
    ocr_ws_pagination_next: "Next page",
    ...
    ocr_ws_memory_refresh_failed: "Text index refresh failed — retry later",
    ocr_ws_index_updated: "正文索引已更新，语义索引需要刷新",
  ...
  zh: {
    ...
    setup_nav_back: "返回",
    setup_nav_cancel: "取消",
    setup_nav_exit: "返回控制中心",
    setup_install_cancelled: "设置已取消，运行时未激活。",
    ...
    foundation_git: "Git",
    foundation_git_missing: "未安装 — 请安装 Git 用于版本控制",
    foundation_obsidian: "Obsidian 版本",
    foundation_obsidian_old: "版本过旧 — 请更新 Obsidian",
    foundation_python_packages: "Python 包",
    foundation_python_packages_checking: "正在检查已安装的包...",
    foundation_paddle_key: "PaddleOCR API 密钥",
    foundation_paddle_missing: "未配置 — OCR 提取需要此密钥",
    ...
    confirmation_default_effect: "此操作将更改 PaperForge 数据。",
    confirm_effect_label: "影响",
    ocr_already_running: "OCR 正在运行。",
    ocr_activity_run: "正在运行 OCR…",
    ocr_activity_rebuild: "正在重建 OCR 衍生结果…",
    ocr_activity_redo: "正在重新执行 OCR…",
    ocr_run_confirm_title: "运行 OCR",
    ocr_run_confirm_body:
      "待处理 PDF 将发送到已配置的 OCR 服务，可能产生费用。每篇论文处理成功前，现有 OCR 结果会保留；运行可安全停止。",
    embed_already_running: "向量构建正在进行。",
    embed_activity_stopping: "正在停止向量构建…",
    embed_activity_building: "正在构建向量索引…",
    embed_rebuild_title: "重建向量索引",
    embed_rebuild_body:
      "调用嵌入 API 可能产生费用。替换索引验证完成前，现有向量仍可用；PDF、笔记和 OCR 均会保留。构建可安全停止。",
    embed_build_complete: "向量索引构建完成。",
    embed_build_warning: "向量索引已发布，但存在警告：{detail}",
    embed_bookkeeping_incomplete: "收尾记录未完成",
    embed_build_stopped: "构建已停止。再次运行即可继续。",
    next_action_pending: "向量嵌入已就绪。请打开“智能检索”查看并运行。",
    next_action_runtime_unavailable:
    ...
    ocr_ws_pagination_previous: "上一页",
    ocr_ws_pagination_next: "下一页",
    ...
    ocr_ws_restore_unavailable: "没有可用的备份版本",
    ocr_ws_detail_rebuild: "重建此论文",
    ocr_ws_memory_refresh: "正在更新本地文本索引…",
    ocr_ws_memory_refresh_failed: "文本索引刷新失败，可稍后重试",
    ocr_ws_index_updated: "正文索引已更新，语义索引需要刷新",
