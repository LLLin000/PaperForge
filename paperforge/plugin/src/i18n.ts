...
const LANG: Record<string, Record<string, string>> = {
    en: {
        ...
        ocr_maint_hero_warn: 'OCR needs attention: {rebuild} rebuild recommended, {failed} failed.',
        ocr_maint_hero_note: 'This page only promotes issues where maintenance is likely to help. Some papers may have limitations that maintenance will not improve.',
        ocr_maint_limitations_intro: 'These papers look less certain, but PaperForge does not currently have a high-confidence maintenance action to recommend.',
    ...
    zh: {
        ...
        ocr_maint_hero_warn: 'OCR 需要关注：{rebuild} 篇建议重建，{failed} 篇处理失败。',
        ocr_maint_hero_note: '本页只提示维护后大概率会改善的问题。部分论文效果一般，维护未必能改善。',
        ocr_maint_limitations_intro: '这类论文通常表示版式复杂或信号偏弱，PaperForge 目前没有高置信度的维护建议。',
