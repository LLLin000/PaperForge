...
class TestRegistryInvariants:
    def test_builtin_registry_is_valid(self) -> None:
        ...
        assert set(ACTION_REGISTRY) == {"memory.build", "embed.resume", "embed.build", "ocr.run", "ocr.rebuild_derived"}
...
class TestCliExitCodes:
    def test_list(self, tmp_path: Path) -> None:
        ...
        assert ids == ["embed.build", "embed.resume", "memory.build", "ocr.rebuild_derived", "ocr.run"]
